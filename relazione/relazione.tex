...
\begin{itemize}
    ...
    \item ai personal trainer, tutti anche istruttori da un punto di vista logico, che possono caricare per i propri clienti una scheda tecnica in formato pdf, di grandezza minore di 1MiB
...
\begin{itemize}
    ...
    \item \textbf{LLM}: Utilizzati per la generazione di contenuti per evitare problemi di copyright.come: il logo, le immagini di sfondo presenti nelle pagine di errore 403 e 404 e le immagini dei vari PT presenti. Usato anche per la popolazione di alcune descrizioni (PT) 
\end{itemize}
...
\begin{itemize}
    \item Creazione e gestione delle pagine: \texttt{home.php},  \texttt{lista-utenti.html},  \texttt{pt.html},  \texttt{cerca-pt.html}
    \item Gestione in css delle stesse 
\end{itemize}
